...
from spec_engine.app.app_utils import services
from spec_engine.app.app_utils.a2a import attach_a2a_routes
from spec_engine.app.app_utils.reasoning_engine_adapter import (
    attach_reasoning_engine_routes,
)
from spec_engine.app.app_utils.telemetry import (
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    from spec_engine.app.agent import app as adk_app
