...
class HumanInteractionEvent(BaseModel):
    ...
    issue_id: Optional[int] = Field(default=None, description="GitHub Issue or Parent Issue ID")
    comment_id: Optional[int] = Field(default=None, description="GitHub Comment ID if applicable")
    ...
    raw_payload: Optional[Dict[str, Any]] = Field(default=None, description="Original raw payload for audit")
